...
grep 'SG' b.csv | head -n 3 >> /sdcard/Download/cdnIP.csv
grep 'HK' b.csv | head -n 3 >> /sdcard/Download/cdnIP.csv
grep 'JP' b.csv | head -n 3 >> /sdcard/Download/cdnIP.csv
grep 'KR' b.csv | head -n 3 >> /sdcard/Download/cdnIP.csv
grep 'TW' b.csv | head -n 3 >> /sdcard/Download/cdnIP.csv
grep 'US' b.csv | head -n 3 >> /sdcard/Download/cdnIP.csv
grep 'GB' b.csv | head -n 3 >> /sdcard/Download/cdnIP.csv
grep 'DE' b.csv | head -n 3 >> /sdcard/Download/cdnIP.csv
grep 'NL' b.csv | head -n 3 >> /sdcard/Download/cdnIP.csv
grep 'FR' b.csv | head -n 3 >> /sdcard/Download/cdnIP.csv
echo
echo "根据每个地区，排名前三的优选IP如下："
cat /sdcard/Download/cdnIP.csv
}
